                ...
                <form method="post" action="config/actions.php?q=add_espaces" role="form">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <input name="numero" type="text" class="form-control" id="exampleInputEmail1"
                                placeholder="Veuillez saisir le numero  de l'espace">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input name="superficie" type="text" class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer la superficie de l'espace">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Position</label>
                            <input name="position" type="text" class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer la position de l'espace">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Bloc</label>
                            <input name="bloc" type="text" class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer le bloc de l'espace">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Enregister</button>
        ...
        <div style="" class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="post" action="config/actions.php?q=update_clients" role="form">
                    <div class="box-body">
                        <input type="hidden" name="id_clients" value="<?= $UpdateCustomers['id_clients']; ?>"
                            class="form-control" id="exampleInputEmail1" placeholder="Veuillez entrer le nom du client">

                        <div class="form-group">
                            <label for="exampleInputEmail1">Nom</label>
                            <input type="text" name="nom" value="<?= $UpdateCustomers['nom']; ?>" class="form-control"
                                id="exampleInputEmail1" placeholder="Veuillez entrer le nom du client">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Prenom</label>
                            <input type="text" name="prenom" value="<?= $UpdateCustomers['prenom']; ?>"
                                class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer le prenom du client">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Adresse</label>
                            <input type="text" name="adresse" value="<?= $UpdateCustomers['adresse']; ?>"
                                class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer l'adresse du client">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Téléphone</label>
                            <input type="number" name="telephone" value="<?= $UpdateCustomers['telephone']; ?>"
                                class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer le telephone du client">
                        </div>
                    </div>
        ...
        <div style="" class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="post" action="config/actions.php?q=update_espaces" role="form">
                    <div class="box-body">
                        <div class="form-group">
                            <input name="id_espaces" type="hidden" value="<?= $UpdateEspaces['id_espaces']; ?>"
                                class="form-control" id="exampleInputEmail1"
                                placeholder="Veuillez  choisir le type de l'espace">
                            <label for="exampleInputEmail1">Numero</label>
                            <input name="numero" type="text" value="<?= $UpdateEspaces['numero']; ?>"
                                class="form-control" id="exampleInputEmail1"
                                placeholder="Veuillez  choisir le type de l'espace">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Superficie</label>
                            <input name="superficie" type="text" value="<?= $UpdateEspaces['superficie']; ?>"
                                class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer la superficie de l'espace">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Position</label>
                            <input name="position" type="text" value="<?= $UpdateEspaces['position']; ?>"
                                class="form-control" id="exampleInputPassword1"
                                placeholder="Veuillez entrer la position de l'espace">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Bloc</label>
                            <input name="bloc" type="text" class="form-control" value="<?= $UpdateEspaces['bloc']; ?>"
                                id="exampleInputPassword1" placeholder="Veuillez entrer le bloc de l'espace">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Enregister</button>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="id_clients" data-placeholder="Choisir un  client"
                                ...
                                <option value="<?= $afficherClient['id_clients']; ?>">
                                    <?= $afficherClient['nom'] . " " . $afficherClient['prenom']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input name="position" type="text"
                                value="<?= $GetEspaces['bloc'] . '-' . $GetEspaces['numero']; ?>" class="form-control"
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Bloc et Numero</label>
                            <input type="text" value="<?= $GetEspaces['bloc'] . '-' . $GetEspaces['numero']; ?>"
        ...
        <div style="" class="col-md-10">
            <div class="box box-primary">
                ...
                <form method="post" action="config/actions.php?q=update_users" role="form">
                    <div class="box-body">
                        <div class="form-group">
                            <input type="hidden" name="id_users" value="<?= $GetUsers['id_users']; ?>"
                                class="form-control" id="exampleInputPassword1">
                            <label for="exampleInputEmail1">Nom</label>
                            <input type="text" name="nom" value="<?= $GetUsers['nom']; ?>" class="form-control"
                                id="exampleInputEmail1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Prenom</label>
                            <input type="text" name="prenom" value="<?= $GetUsers['prenom']; ?>" class="form-control"
                                id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Login</label>
                            <input type="text" name="login" value="<?= $GetUsers['login']; ?>" class="form-control"
                                id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Password</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="auth_confirm" value="<?= $GetUsers['auth_confirm']; ?>"
                                class="form-control" id="exampleInputPassword1">
                        </div>
                    </div>
                    <div class="box-footer">
...
<?php } ?>
<?php if ($_GET['display'] == 'passcode') { ?>
<section class="content">
    <div class="row">
        <div style="  margin-left: 200px; margin-right: auto;" class="col-md-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Entrer un code Pin</h3>
                </div>
                <form method="post" action="config/actions.php?q=update_pin" role="form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Password</label>
                            <input type="password" name="auth_confirm" class="form-control" id="exampleInputEmail1"
                                required>
                        </div>
                    </div>
                    <div class="box-footer">
...
<?php if ($_GET['display'] == 'add_carnet') { ?>
<section class="content">
    <div class="row">
        <div style="" class="col-md-12">
            <div class="box box-primary">
                ...
                <form method="post" action="config/actions.php?q=add_carnet" role="form">
                    <div class="box-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Numero Carnet</label>
                            <input type="int" name="numero_carnet" class="form-control" id="exampleInputEmail1"
                                placeholder="Veuillez entrer le numero du carnet">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Plage1</label>
                            <input type="int" name="plage1" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Plage2</label>
                            <input type="int" name="plage2" class="form-control" id="exampleInputPassword1">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Detenteur</label>
                            <input type="text" name="detenteur" class="form-control" id="exampleInputPassword1">
                        </div>
                    </div>
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">Enregister</button>
